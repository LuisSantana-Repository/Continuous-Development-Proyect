export const BUCKET = process.env.S3_BUCKET_NAME || process.env.S3_BUCKET || "local-bucket";
...
export const DYNAMODB_CHATS_TABLE = process.env.DYNAMODB_CHATS_TABLE || "chats";

export const DYNAMODB_MESSAGES_TABLE = process.env.DYNAMODB_MESSAGES_TABLE || "messages";