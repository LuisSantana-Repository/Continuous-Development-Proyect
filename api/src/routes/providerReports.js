...
/**
 * GET /provider-reports/provider/:providerId
...
router.get("/provider/:providerId", authenticate, async (req, res) => {
  try {
    ...
    console.log(
      "GET /provider-reports/provider/:providerId - Request params:",
      {
        providerId,
        query: req.query,
      }
...
/**
 * GET /provider-reports/client/:userId
...
router.get("/client/:userId", authenticate, async (req, res) => {
  try {
    ...
    console.log("GET /provider-reports/client/:userId - Request params:", {
      userId,
      authenticatedUserId,
      query: req.query,
    });
...
/**
 * GET /provider-reports/client/:userId/stats
...
/**
 * PATCH /provider-reports/:reportId
...
/**
 * DELETE /provider-reports/:reportId
